...
namespace TUM.CMS.VplControl.BimPlus.Nodes
{
    public class BimPlusWatch3DNode : Watch3DNode
    {
        ...
        public override void Calculate()
        {
            ...
            // Input is of type DbGeometry
            else if (InputPorts[0].Data != null && InputPorts[0].Data.GetType() == typeof(List<DbGeometry>))
            {
                Worker = new BackgroundWorker { WorkerReportsProgress = true, WorkerSupportsCancellation = true };
                Worker.DoWork += WorkerOnDoWork;
                // Worker.ProgressChanged += WorkerOnProgressChanged;
        ...
        private void WorkerOnDoWork(object sender, DoWorkEventArgs doWorkEventArgs)
        {
            ...
            {
                doWorkEventArgs.Result = VisualizeBimPlusDataAsGenericElements(InputPorts[0].Data as List<GenericElement>, sender);
            }
